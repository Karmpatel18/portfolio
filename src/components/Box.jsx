  ...
  return (
      ...
      <div className='font-montserrat'>
        <div className="flex flex-col place-content-between p-10 lg:ml-40 lg:mr-40 sm:ml-16 sm:mr-16 m-4 rounded-3xl h-[508px] w-auto bg-gray-100">
            ...
            <div className="flex sm:flex-row space-x-6 flex-col  ">
              <button className='bg-[#1D1D1D]  px-10 py-3 rounded-full  font-medium text-white text-center '>Contact me</button>
